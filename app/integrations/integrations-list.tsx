...
function IntegrationCard({ item, index }: CardProps) {
  return (
    <div key={index} className="bg-gradient-to-tr from-zinc-800 to-zinc-800/25 rounded-3xl border border-zinc-800 hover:border-zinc-700/60 transition-colors group relative">
      <div className="flex flex-col p-5 h-full">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <Link className="font-semibold bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 group-hover:before:absolute group-hover:before:inset-0" href={item.link}>{item.name}</Link>
        </div>
        <div className="grow">
    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pb-12 md:pb-20">
          {/* Tobpabr */}
          <div className="flex justify-between items-center py-6 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.zinc.800),transparent)1] space-x-8 overflow-x-scroll no-scrollbar">
            {/* Links */}
            <ul className="flex flex-nowrap text-sm font-medium space-x-8">
              <li>
                <a className="flex items-center text-zinc-50 hover:text-white whitespace-nowrap transition-colors space-x-2" href="#engineering">
                  <svg className="fill-zinc-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
              ...
              <li>
                <a className="flex items-center text-zinc-50 hover:text-white whitespace-nowrap transition-colors space-x-2" href="#nocode">
                  <svg className="fill-zinc-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
              ...
              <li>
                <a className="flex items-center text-zinc-50 hover:text-white whitespace-nowrap transition-colors space-x-2" href="#collaboration">
                  <svg className="fill-zinc-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
              ...
              <li>
                <a className="flex items-center text-zinc-50 hover:text-white whitespace-nowrap transition-colors space-x-2" href="#productivity">
                  <svg className="fill-zinc-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
            ...
            <div>
              <form className="relative flex items-center">
                <input className="form-input pl-10 bg-transparent rounded-none focus:border-transparent focus:border-b-zinc-700 lg:w-9 lg:focus:w-[200px] transition-[width]" type="text" id="search" aria-label="Search…" placeholder="Search…" autoComplete="off" />
                <div className="absolute inset-0 w-9 flex items-center justify-center pointer-events-none">
                  <svg className="absolute fill-zinc-50 mx-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
          ...
          <div>
            ...
            <div className="mt-12 md:mt-16">
              <h3 id="engineering" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-8">Engineering</h3>
            ...
            {/* Section #2 */}
            <div className="mt-12 md:mt-16">
              <h3 id="nocode" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-8">No-code</h3>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Section #3 */}
            <div className="mt-12 md:mt-16">
              <h3 id="collaboration" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-8">Collaboration</h3>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Section #4 */}
            <div className="mt-12 md:mt-16">
              <h3 id="productivity" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-8">Productivity</h3>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
