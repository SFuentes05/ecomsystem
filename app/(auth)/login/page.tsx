  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto text-center pb-12">
        ...
        <AuthLogo />
        {/* Page title */}
        <h1 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60">Sign in to your account</h1>
      </div>
      ...
      <div className="max-w-sm mx-auto">
        ...
        <div className="text-center mt-4">
          <div className="text-sm text-zinc-400">
            Don't have an account? <Link className="font-medium text-emerald-500 hover:text-emerald-400 transition duration-150 ease-in-out" href="/signup">Sign up</Link>
          </div>
        </div>
