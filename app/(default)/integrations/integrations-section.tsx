...
export default function IntegrationsSection() {
  return (
    <section className="relative">
      ...
      {/* Opacity layer */}
      <div className="absolute inset-0 bg-zinc-900 opacity-60 -z-10" aria-hidden="true"></div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 md:pt-40">
          ...
          <div className="text-center pb-12 md:pb-20">
            <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 to-emerald-200 pb-3">Integrations & Add-ons</div>
            <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-4">Make Stellar uniquely yours</h1>
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-zinc-400">Our landing page template works on all devices, so you only have to set it up once, and get beautiful results forever.</p>
            </div>
          </div>
