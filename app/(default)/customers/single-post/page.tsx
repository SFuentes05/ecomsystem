  ...
  return (
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 md:pt-40 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.zinc.800),transparent)1]">
            ...
            <div className="md:grow pb-12 md:pb-20">
              <div className="max-w-3xl">
                ...
                <article className="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.zinc.800),transparent)1]">
                  ...
                  <div className="mb-4">
                    <Link className="inline-flex text-sm font-medium text-emerald-500 group" href="/customers"><span className="tracking-normal group-hover:-translate-x-0.5 transition-transform duration-150 ease-in-out mr-1">&lt;-</span> Go Back</Link>
                  </div>

                  <header>
                    <h1 className="h2 inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-4">How Airbnb leverages Stellar X to onboard new hosts</h1>
                    <div className="text-sm flex items-center space-x-4 mb-8">
                      ...
                      <div>
                        <div className="text-zinc-300 font-medium">Becky Taylor</div>
                        <div className="text-zinc-500">Product Marketing Manager</div>
                      </div>
                    </div>
                  </header>
                    ...
                    <div className="px-5 py-6">
                      <div className="mb-5">
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="text-lg font-semibold text-zinc-100">Airbnb Inc.</div>
                        </div>
                      </div>
                      <ul className="text-sm">
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.zinc.700/.3),theme(colors.zinc.700),theme(colors.zinc.700/.3))1]">
                          ...
                          <span className="text-zinc-300 font-medium">San Francisco</span>
                        </li>
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.zinc.700/.3),theme(colors.zinc.700),theme(colors.zinc.700/.3))1]">
                        ...
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.zinc.700/.3),theme(colors.zinc.700),theme(colors.zinc.700/.3))1]">
                          ...
                          <span className="text-zinc-300 font-medium">Hospitality</span>
                        </li>
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.zinc.700/.3),theme(colors.zinc.700),theme(colors.zinc.700/.3))1]">
                          <span className="text-zinc-400">Product</span>
                          <span className="text-zinc-300 font-medium">Stellar X</span>
                        </li>
                        <li className="flex items-center justify-between space-x-2 py-3 border-t [border-image:linear-gradient(to_right,theme(colors.zinc.700/.3),theme(colors.zinc.700),theme(colors.zinc.700/.3))1]">
                          <span className="text-zinc-400">Impact</span>
                          <span className="text-zinc-300 font-medium">+7% new hosts</span>
                        </li>
                      </ul>
                    </div>
                  </div>
