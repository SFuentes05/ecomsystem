  ...
  <div className="max-w-[352px] mx-auto sm:max-w-[728px] lg:max-w-none pb-12 md:pb-20">
    <Highlighter className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 group [&_*:nth-child(n+5):not(:nth-child(n+12))]:order-1 [&_*:nth-child(n+10):not(:nth-child(n+11))]:!order-2">
      ...
      <div className="flex flex-col items-center justify-center text-center p-4">
        <p className="font-medium bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-3">
      ...
      <div className="flex flex-col items-center justify-center text-center p-4">
        ...
        <div className="text-sm font-medium text-zinc-300">
          Mirko Mitt <span className="text-zinc-700">-</span> <a className="text-emerald-500 hover:underline" href="#0">Mildrink</a>
        </div>
      </div>
