...
export default function Features() {
  ...
  const content = {
    1: {
      ...
      description: "Access comprehensive market analysis from 28+ trusted sources. Get real-time data on market trends, competitor analysis, and country-specific insights to make informed decisions for your e-commerce business."
    },
    2: {
      title: "Product Research Suite",
      subtitle: "Trending products finder",
      description: "Discover high-potential products with our curated database of best-sellers across multiple marketplaces. Get detailed metrics on product performance, profit margins, and seasonal trends."
    },
    3: {
      title: "E-commerce Toolkit",
      subtitle: "All-in-one resource hub",
      description: "Find the perfect tools and resources to launch your store. Compare platforms, automation tools, and marketing solutions, backed by real user reviews and success stories from our community."
    }
  }
          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
                <div>
                  <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 to-emerald-200 pb-3">
                    {content[tab as keyof typeof content].subtitle}
                  </div>
                </div>
                <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-3">
                ...
                <div className="mt-8 max-w-xs max-md:mx-auto space-y-2">
                  <button className={`flex items-center text-sm font-medium text-zinc-50 rounded border bg-zinc-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${tab !== 1 ? 'border-zinc-700 opacity-50' : 'border-emerald-700 shadow shadow-emerald-500/25'}`} onClick={() => setTab(1)}>
                  ...
                  <button className={`flex items-center text-sm font-medium text-zinc-50 rounded border bg-zinc-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${tab !== 2 ? 'border-zinc-700 opacity-50' : 'border-emerald-700 shadow shadow-emerald-500/25'}`} onClick={() => setTab(2)}>
                    <svg className="shrink-0 fill-zinc-300 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                      <path d="M2 6H0V2a2 2 0 0 1 2-2h4v2H2v4ZM16 6h-2V2h-4V0h4a2 2 0 0 1 2 2v4ZM14 16h-4v-2h4v-4h2v4a2 2 0 0 1-2 2ZM6 16H2a2 2 0 0 1-2-2v-4h2v4h4v2Z" />
                    </svg>
                    <span>Trending Products</span>
                  </button>
                  <button className={`flex items-center text-sm font-medium text-zinc-50 rounded border bg-zinc-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${tab !== 3 ? 'border-zinc-700 opacity-50' : 'border-emerald-700 shadow shadow-emerald-500/25'}`} onClick={() => setTab(3)}>
                    <svg className="shrink-0 fill-zinc-300 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <div className="relative w-48 h-48 flex justify-center items-center">
                      ...
                      <svg className="absolute inset-0 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 will-change-transform pointer-events-none blur-md" width="480" height="480" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                          <linearGradient id="pulse-a" x1="50%" x2="50%" y1="100%" y2="0%">
                            ...
                            <stop offset="76.382%" stopColor="#10b981" />
                      ...
                      <div className="absolute inset-0 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none w-[500px] h-[500px] rounded-full overflow-hidden [mask-image:_radial-gradient(black,_transparent_60%)]">
                        <div className="h-[200%] animate-endless">
                          ...
                          <div className="absolute inset-0 [background:_repeating-linear-gradient(transparent,_transparent_48px,_theme(colors.emerald.500)_48px,_theme(colors.emerald.500)_49px)]" />
                          ...
                          <div className="absolute inset-0 [background:_repeating-linear-gradient(90deg,transparent,_transparent_48px,_theme(colors.emerald.500)_48px,_theme(colors.emerald.500)_49px)]" />
                        </div>
                      </div>
                      {/* Icons */}
                      <Transition
                        ...
                        appear={true}
                      >                      
                        <div className="relative flex items-center justify-center w-16 h-16 border border-transparent rounded-2xl shadow-2xl -rotate-[14deg] [background:linear-gradient(theme(colors.zinc.900),_theme(colors.zinc.900))_padding-box,_conic-gradient(theme(colors.zinc.400),_theme(colors.zinc.700)_25%,_theme(colors.zinc.700)_75%,_theme(colors.zinc.400)_100%)_border-box] before:absolute before:inset-0 before:bg-zinc-800/30 before:rounded-2xl">
                          <svg className="relative fill-zinc-200" xmlns="http://www.w3.org/2000/svg" width="23" height="25">
                      ...
                      >    
                        <div className="relative flex items-center justify-center w-16 h-16 border border-transparent rounded-2xl shadow-2xl -rotate-[14deg] [background:linear-gradient(theme(colors.zinc.900),_theme(colors.zinc.900))_padding-box,_conic-gradient(theme(colors.zinc.400),_theme(colors.zinc.700)_25%,_theme(colors.zinc.700)_75%,_theme(colors.zinc.400)_100%)_border-box] before:absolute before:inset-0 before:bg-zinc-800/30 before:rounded-2xl">
                          <svg className="relative fill-zinc-200" xmlns="http://www.w3.org/2000/svg" width="22" height="22">
                      ...
                      >    
                        <div className="relative flex items-center justify-center w-16 h-16 border border-transparent rounded-2xl shadow-2xl -rotate-[14deg] [background:linear-gradient(theme(colors.zinc.900),_theme(colors.zinc.900))_padding-box,_conic-gradient(theme(colors.zinc.400),_theme(colors.zinc.700)_25%,_theme(colors.zinc.700)_75%,_theme(colors.zinc.400)_100%)_border-box] before:absolute before:inset-0 before:bg-zinc-800/30 before:rounded-2xl">
                          <svg className="relative fill-zinc-200" xmlns="http://www.w3.org/2000/svg" width="26" height="14">
