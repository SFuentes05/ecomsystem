    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.zinc.800),transparent)1]">
        ...
        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <div>
            <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 to-emerald-200 pb-3">Getting started with Stellar</div>
          </div>
          <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-4">Everything you need to know</h2>
        </div>
        ...
        <div className="md:flex md:space-x-12 space-y-8 md:space-y-0">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <p className="text-zinc-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum.</p>
            </div>
