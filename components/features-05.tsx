      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-zinc-200 to-zinc-200/60 pb-4">Stop overpaying for software</h2>
            <p className="text-lg text-zinc-400">There are many variations available, but the majority have suffered alteration in some form, by injected humour.</p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {/* Card #1 */}
            <div className="bg-gradient-to-tr from-zinc-800/50 to-zinc-800/10 rounded-3xl border border-zinc-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                <svg className="shrink-0" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                  <path className="fill-emerald-500" fillOpacity=".24" d="M10 0C4.5 0 0 4.5 0 10s4.5 10 10 10 10-4.5 10-10S15.5 0 10 0Z" />
                  <path className="fill-emerald-400" fillRule="nonzero" d="M13 6.586 14.414 8l-5.747 5.748-3.081-3.081L7 9.252l1.667 1.667z" />
                </svg>
                <p className="text-sm text-zinc-400">
                  Purpose-built for company that requires more than a <strong className="text-zinc-300 font-medium">simple plan</strong> with security infrastructure.
                </p>
              </div>
            </div>
            {/* Card #2 */}
            <div className="bg-gradient-to-tr from-zinc-800/50 to-zinc-800/10 rounded-3xl border border-zinc-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-zinc-400">
                  AI-powered to <strong className="text-zinc-300 font-medium">remove the burdens</strong> of tedious knowledge management and security tasks.
                </p>
              </div>
            </div>
            {/* Card #3 */}
            <div className="bg-gradient-to-tr from-zinc-800/50 to-zinc-800/10 rounded-3xl border border-zinc-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-zinc-400">
                  There's no prioritized support in Stellar. You can use email or live chat and you will hear back in a <strong className="text-zinc-300 font-medium">couple of hours</strong>.
                </p>
              </div>
            </div>
            {/* Card #4 */}
            <div className="bg-gradient-to-tr from-zinc-800/50 to-zinc-800/10 rounded-3xl border border-zinc-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-zinc-400">
                  Comprehensive <strong className="text-zinc-300 font-medium">developer docs</strong> and a centralized support center packed many resources.
                </p>
              </div>
            </div>
            {/* Card #5 */}
            <div className="bg-gradient-to-tr from-zinc-800/50 to-zinc-800/10 rounded-3xl border border-zinc-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-zinc-400">
                  No upcharges—and we'd never upsell you to a higher plan or a <strong className="text-zinc-300 font-medium">dedicated IP</strong> to improve deliverability.
                </p>
              </div>
            </div>
            {/* Card #6 */}
            <div className="bg-gradient-to-tr from-zinc-800/50 to-zinc-800/10 rounded-3xl border border-zinc-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-zinc-400">
                  Tool training, dedicated resources, and <strong className="text-zinc-300 font-medium">regular updates</strong> are available for both small and large teams.
                </p>
              </div>
            </div>
          </div>
